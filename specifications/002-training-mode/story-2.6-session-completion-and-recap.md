...
- The recap shows the session's own statistics (same breakdown as Story 2.3/2.4: skipped/found/not-found per level), not the profile's lifetime statistics (Story 1.5).
...
- **And** it shows the session's own statistics (skipped/found/not-found, per level)
...
## Out of scope
- A history of past completed sessions (once a new session starts, the completed one is gone, same as Story 2.5).
