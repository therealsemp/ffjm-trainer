...
- Below the rank, the recap still shows the session's own statistics (same breakdown as Story 2.3: skipped total, found/not-found per level), not the profile's lifetime statistics (Story 1.5).
